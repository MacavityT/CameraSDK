...
namespace AqDevice
{
    public interface IAqCamera
    {
        ...
        AqDevice.TriggerSwitchs TriggerSwitch { get; set; }
        AqDevice.TriggerModes TriggerMode { get; set; }
        AqDevice.TriggerEdges TriggerEdge { get; set; }
        ...
        //set image ROI
        Int64 ImageWidth { get; set; }
        Int64 ImageHeight { get; set; }
        Int64 ImageoffsetX { get; set; }
        Int64 ImageoffsetY { get; set; }
		bool IsCameraOpened { get; set; }
		bool IsStreamOpened { get; set; }
    }
}
